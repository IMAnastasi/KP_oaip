...
begin
  ...
  Pictures.LoadFromFile(ExtractFilePath(ParamStr(0))+'парные картинки\картинка.bmp');
  ...
  if count = 1 then begin
    ...
    if (open1.col = open2.col) and (open1.row = open2.row)
      ...
      if Pole[open1.col,open1.row] = Pole[open2.col,open2.row] then
        ...
        begin
          n := n+1;
          Form10.Timer1.Enabled := True; // запустить таймер
...
begin
  ...
  begin
    ...
    Form10.Canvas.Font.Color := clBlack;
    Form10.Canvas.TextOut(350,350,'Победа!');
...
//возврат на форму "Инры" и новая игра
